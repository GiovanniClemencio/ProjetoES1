 ...
 * @author Luan
 */
public class TelaConsultaLancamentoCategoria extends javax.swing.JFrame {
    ...
    public TelaConsultaLancamentoCategoria(java.awt.Frame parent, ControladorLancamento ctrlLancamento, ControladorCategoria ctrlCategoria, Categoria categoria) {
    ...
    private void carregarRelatorio() {
        ...
        ArrayList<Lancamento> lancamentoCategoria = ctrlRelatorio.gerarRelatorio(null, null, null, categorias, null, null);

        labelTitulo.setText(categoria.getNome());

        StringBuilder sb = new StringBuilder();
        sb.append("==============================================================\n");
        sb.append("                  Lançamentos da Categoria                    \n");
        sb.append("==============================================================\n");
        ...
        // Vazia
        if (lancamentoCategoria == null || lancamentoCategoria.isEmpty()) {
            sb.append(" Nenhum lançamento encontrado para a categoria.\n");
        } else {
            // Formatos auxiliares
            java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("dd/MM/yyyy");

            for (Lancamento l : lancamentoCategoria) {
